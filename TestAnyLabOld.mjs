...
let labSettings = {
    ...
    isHTML: true, // true if this is an HTML and CSS lab
...
if (quitProgram != true) {
    ...
    for (const studentDir of fs
        ...
        report += await findSubDirAndCheck(
...
function loadSettings(requirementsFileName) {
    ...
    /* settings array elements will hold these settings values:
        ...
        5: Check HTML files  // TODO: separate HTML and CSS checks
        6. Check CSS files
    ...
    */
    ...
    labSettings.isHTML = (settings[4].toLowerCase() == "true");  // Currenty for HTML & CSS
    labSettings.isCSS = (settings[5].toLowerCase() == "true");  // Currently not used 3/10/24
    labSettings.isJavaScript = (settings[6].toLowerCase() == "true");
...
/********************************************************/
async function findSubDirAndCheck(
    numParts,    // number of parts in the lab assignment
    ...
    try {
        ...
        if (areAllInOneDir && numParts == 1) {
            // TODO: Write this code
        }
        else if (areAllInOneDir && numParts > 1) {
            // There are files for two or more parts in the dir at studentDirPath
            // Find the file for each part and check it.
            await findAndCheckLabPartFiles(studentDirPath);
        }
        else if (!areAllInOneDir && numParts == 1)  // like lab 4 in fall 2023
        {
        ...
        else if (!areAllInOneDir && numParts > 1)   // Lab 3 in fall 2023 is like this
        {
    ...
    /****************************************************************/
    async function findAndCheckLabPartFiles(
